...
- Java uses camel casing while Python uses underscores (naming convention)
- Java requires ; to end a statement
- Similar formats with if else statements
- Java uses {} while Python uses :
- Java uses // while Python uses # (commenting)
- Similar ways of calling functions
